    ...
    def galian_tanah_dengan_excavator(self):
        ...
        return {
	        data: {
                ...
                'Satuan': [np.nan, SATUAN_EXCAVATOR, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_EXCAVATOR, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan, self.excavator, self.pekerja,  self.mandor]
                },
...
class GalianDrainaseDenganExcavator:
    ...
    def galian_drainase_dengan_excavator(self):
        ...
        return {
	        data: {
                'Uraian': ['Galian', 'Excavator', 'Dump Truck', 'Pekerja (Buruh Tidak Terampil)', 'Mandor'],
                'Koefisien': [np.nan, 0.0076, 0.117, 0.0043, 0.0011],
                'Volume': [np.nan] + [self.volume_galian] * 4,
                'Satuan': [np.nan, SATUAN_EXCAVATOR, SATUAN_DUMP_TRUCK, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_EXCAVATOR, HSPK_DUMP_TRUCK, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan, self.excavator, self.pekerja,  self.mandor]
                },
	        subtotal: self.ahsp_total
	}
    ...
    def galian_biasa_dengan_excavator(self):
        ...
        return {
            data: {
                ...
                'Satuan': [np.nan, SATUAN_EXCAVATOR, SATUAN_DUMP_TRUCK, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_EXCAVATOR, HSPK_DUMP_TRUCK, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan, self.excavator, self.dump_truck,self.pekerja,  self.mandor]
                },
            subtotal: self.ahsp_total
            }
...
class GalianBatuDenganExcavator:
    ...
    def peralatan(self):
        ...
        self.dump_truck = 0.3329 * HSPK_DUMP_TRUCK * self.volume_galian
    ...
    def galian_biasa_dengan_excavator(self):
        ...
        return {
            data: {
                ...
                'Satuan': [np.nan, SATUAN_COMPRESSOR, SATUAN_JACK_HAMMER, SATUAN_WHEEL_LOADER, SATUAN_EXCAVATOR, SATUAN_DUMP_TRUCK, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_COMPRESSOR, HSPK_JACK_HAMMER, HSPK_WHEEL_LOADER, HSPK_EXCAVATOR, HSPK_DUMP_TRUCK, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan, self.compressor, self.jack_hammer, self.wheel_loader, self.excavator, self.pekerja,  self.mandor]
                },
            subtotal: self.ahsp_total
        }
    ...
    def galian_tanah_biasa_manual(self):
        ...
        return {
            data: {
                ...
                'Koefisien': [np.nan, self.koefisien_galian['pekerja'], self.koefisien_galian['mandor']],
                'Volume': [np.nan] + [self.volume_galian] * 2,
                'Satuan': [np.nan, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan,self.pekerja, self.mandor]
                },
            subtotal: self.ahsp_total
        }
    ...
    def galian_tanah_biasa_semi_mekanis(self):
        ...
        return {
            data: {
                ...
                'Koefisien': [np.nan, self.koefisien_galian['pertamina_dex'], 0.05, self.koefisien_galian['pekerja'], self.koefisien_galian['mandor'] ],
                'Volume': [np.nan] + [self.volume_galian] * 4,
                'Satuan': [np.nan, SATUAN_PERTAMINA_DEX, SATUAN_JACK_HAMMER, SATUAN_PEKERJA, SATUAN_MANDOR],
                'Harga Satuan': [np.nan, HSPK_PERTAMINA_DEX, HSPK_JACK_HAMMER, HSPK_PEKERJA, HSPK_MANDOR],
                'Jumlah': [np.nan, self.pertamina_dex, self.jack_hammer, self.pekerja,  self.mandor ]
                },
            subtotal: self.ahsp_total
        }
...
class PemadatanTanahDenganStamper:
    ...
    def pemadatan_tanah_dengan_stamper(self):
        ...
        return {
                data: {
                        'Uraian' : ['Pemadatan', 'Pekerja', 'Mandor', 'Tukang', 'Stamper'],
                        'Koefisien' : [np.nan, 0.062, 0.186, 0.0062, 0.05],
...
class PemadatanTanahDenganBulldozer:
    ...
    def pemadatan_dengan_bulldozer(self):
        self.tenaga()
        self.peralatan()
        self.ahsp_pemadatan_tanah_dengan_bulldozer()
        return {
                data: {
                        'Uraian' : ['Pemadatan', 'Pekerja','Mandor', 'Tukang', 'Buldozzer','Water Tanker', 'Roller Fibrator'],
                        'Koefisien': [np.nan, 0.062, 0.186, 0.0062, 0.02, 0.0078, 0.0178],
                        'Volume' : [np.nan] + [self.volume_pemadatan]*7,
                        'Satuan': [np.nan,
                                SATUAN_PEKERJA,
                                SATUAN_MANDOR,
                                SATUAN_TUKANG,
...
class PemadatanBetonDenganVibrator:
    ...
    def pemadatan_dengan_vibrator(self):
        self.tenaga()
        self.peralatan()
        self.ahsp_pemadatan_beton_dengan_vibrator()
        return {
                data: {
                    'Uraian': ['Pemadatan','Pekerja', 'Mandor', 'Vibrator_Roller'],
                    'Koefisien': [np.nan, 0.25, 0.025, 0.025, 0.1],
                    'Volume': [np.nan] + [self.volume_pemadatan]*4,
                    'Satuan':[np.nan, 
                            SATUAN_PEKERJA,
                            SATUAN_MANDOR,
                            SATUAN_VIBRATOR_ROLLER],
                    'Harga Satuan': [np.nan,
                                    HSPK_PEKERJA,
                                    HSPK-MANDOR,
                                    HSPK_VIBRATOR_ROLLER],
                    'Jumlah':[np.nan,
                            self.pekerja,
                            self.mandor,
                            self.vibrator_roller]
...
class PerkerasanBetonSemen:
    ...
    def perkerasan_beton_semen(self):
        ...
        return {
                data: {
                    'Uraian': ['Perkerasan', 'Pekerja', 'Tukang', 'Mandor','Semen 40 kg', 'Pasir Urug', 'Baja Tulangan Polos', 'Joint Sealent', 'Cat Anti Karat', 'Expansion Cap', 'Polytene 125 Mikron','Curing Compound','Formwork Plate', 'Paku','Additive','Wheel Loader','Batching Plant', 'Truck Mixer','Concrete Vibrator','Water Tanker','Slip Form Paver'],
                    'Koefisien': [np.nan, 0.2008, 0.1004, 0.0215, 10.25, 0.6237, 45, 0.99, 0.02, 0.17, 0.3281, 0.6525, 0.57, 0.35, 0.8568, 0.0244, 0.0502, 0.4942, 0.0502, 0.0422, 0.0074]
...
class PerkerasanJalanBeton:
    ...
    def perkerasan_beton_semen(self):
        ...
        return {
                data:{
                    'Uraian': ['Perkerasan', 'Pekerja', 'Tukang', 'Mandor','Semen 40 kg', 'Pasir Urug', 'Baja Tulangan Polos', 'Joint Sealent', 'Cat Anti Karat', 'Expansion Cap', 'Polytene 125 Mikron','Curing Compound','Multipleks 12 mm', 'Kayu Acuan','Paku','Additive','Wheel Loader','Batching Plant', 'Truck Mixer','Concrete Vibrator','Water Tanker','Slip Form Paver']
                    'Koefisien': [np.nan, 0.200, 0.1004, 0.0215, 2.1781, 0.6237, 15.875, 0.99, 0.02, 0.17, 0.4375, 0.87, 0.16, 0.096, 1.024, 0.9139, 0.0244, 0.0502, 0.6709, 0.0502, 0.0422, 0.0074],
